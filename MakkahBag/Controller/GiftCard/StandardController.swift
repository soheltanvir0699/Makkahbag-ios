...
//  MakkahBag
//
//  Created by appleguru on 17/4/20.
...
import Nuke
import AVKit
class StandardController: UIViewController {
    ...
    func giftCardTypeApiClient() {
        ...
        let request = NSMutableURLRequest(url: NSURL(string: BaseURL+"/single-gift-card-type-S")! as URL)
...
extension StandardController: UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "StandardCell", for: indexPath) as! StanderCell
        ...
        let pathExtention = url?.pathExtension
            ...
            {
                DispatchQueue.main.async {
                    let image = self.getThumbnail(url!)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let cell = collectionView.cellForItem(at: indexPath as IndexPath) as! StanderCell
